...
import { querySchema, priceSchema, heatLevelSchema, type SauceFilters } from "../schemas/sauce-filters-schema";
...
export default async function SaucesPage(props: SaucesPageProps) {
    ...
    heatLevel: parseFilter(
      heatLevelSchema,
      rawFilters.heatLevel,
    )
  };
...
<main className="p-6">
  <h1 className="mb-8 text-3xl font-bold">Hot Sauces</h1>
